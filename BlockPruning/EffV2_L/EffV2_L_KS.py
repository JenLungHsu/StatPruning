...
#     del model.blocks[4][18]
#     del model.blocks[4][17]
#     del model.blocks[4][15]
#     for i in range(13, 5, -1):  # 逆向刪除，避免索引錯亂
...
def EffV2_L_KS():
    ...
    for i in range(9, 3, -1):  # 逆向刪除，避免索引錯亂
        del model.blocks[3][i]
    del model.blocks[3][2]

    for i in range(6, 2, -1):  # 逆向刪除，避免索引錯亂
