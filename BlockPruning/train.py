...
if __name__ == "__main__":
    ...
    print('pos_weight:',negative_samples / positive_samples)
    net = model_efficient.EFB4DFR(
        num_classes=cfg["dataset"]["labels"],
        backbone=cfg["model"]["backbone"],
        freeze_backbone=cfg["model"]["freeze_backbone"],
        add_magnitude_channel=cfg["model"]["add_magnitude_channel"],
        add_phase_channel=cfg["model"]["add_phase_channel"],
