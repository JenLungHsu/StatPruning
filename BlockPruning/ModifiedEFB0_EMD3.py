...
class ModifiedEFB0_EMD3(nn.Module):
    def __init__(self, original_model):
        super(ModifiedEFB0_EMD3, self).__init__()
        ...
        self.stage4 = nn.Sequential(
            ...
            original_model.features.stage4.unit2,
            original_model.features.stage4.unit4,
            original_model.features.stage4.unit5
        )
...
if __name__ == "__main__":
    ...
    # 建立新模型，只保留你想要的部分
    modified_model = ModifiedEFB0_EMD3(original_model)
