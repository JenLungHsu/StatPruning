...
#     for i in range(17, 0, -1):  # 逆向刪除，避免索引錯亂
#         del model.blocks[5][i]
#     for i in range(13, 0, -1):  # 逆向刪除，避免索引錯亂
#         del model.blocks[4][i]
#     for i in range(6, 0, -1):  # 逆向刪除，避免索引錯亂
#         del model.blocks[3][i]

#     del model.blocks[2][4]
#     del model.blocks[2][1]

#     del model.blocks[1][4]
#     del model.blocks[1][1]
