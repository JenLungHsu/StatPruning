...
def main():
    ...
    model_full = torch.nn.DataParallel(resnet_cifar10.__dict__[args.arch]())
    model_prune = torch.nn.DataParallel(resnet_cifar10.__dict__[args.arch]())
    ...
    # --- 匯出最終紀錄 ---
    save_combined_csv(recorder_full, recorder_prune, "prune_vs_baseline_r110_c10.csv")
...
# --- 合併紀錄成 CSV ---
def save_combined_csv(recorder1, recorder2, output_path="training_comparison_R110_C10.csv"):
