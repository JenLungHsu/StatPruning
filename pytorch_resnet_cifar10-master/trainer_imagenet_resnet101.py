...
def main():
    ...
    if args.evaluate:
        if args.pruning_method == 'MW':
            path = "/ssd5/Roy/pytorch_resnet_cifar10-master/save_resnet101_imagenet_planA/MW/best_model.th"
            # path = "/ssd5/Roy/pytorch_resnet_cifar10-master/save_resnet101_imagenet_planB/MW/best_model.th"
