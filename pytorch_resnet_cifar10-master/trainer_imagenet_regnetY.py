...
def main():
    ...
    if args.pretrained:
        model = regnet_y_400mf(weights=RegNet_Y_400MF_Weights.IMAGENET1K_V1)
        model.cuda()
    ...
    if args.pruning_method:
        ...
        if args.pruning_method == 'MW':
            del model.trunk_output.block4[3]
            del model.trunk_output.block4[2]
    ...
    if args.evaluate:
        if args.pruning_method == 'MW':
            path = "/ssd5/Roy/pytorch_resnet_cifar10-master/save_regnetY_imagenet/MW/best_model.th"
