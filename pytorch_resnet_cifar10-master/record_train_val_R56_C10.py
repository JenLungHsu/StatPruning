...
def main():
    ...
    if args.pruning_method:
        ...
        if args.pruning_method == 'KS':
            # ---------32----------
            del model_prune.module.layer3[7]
            del model_prune.module.layer3[2]

            del model_prune.module.layer2[8]
    ...
    # --- 匯出最終紀錄 ---
    save_combined_csv(recorder_full, recorder_prune, "prune_vs_baseline_r56_c10.csv")
